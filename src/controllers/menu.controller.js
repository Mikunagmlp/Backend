    ...
    if (MenuLiquidoInicial==0) {
       ...
       montoLiquidoUtilizadoInicial; 
        ...
        const newProductoLiquidoInicial = {
            ...
            montoLiquidoInicial:(montoLiquidoUtilizadoInicial2).toFixed(2)
        }
...
menuCtrl.getSolidoPrimario = async(req, res)=>{
    ...
    const MenuSolidoPrimaria = await Menu.find({CodigoSolidoPrimaria:getProductosSolitoPrimaria.CodigoProducto});
...
menuCtrl.getLiquidoPrimario = async(req, res)=>{
    ...
    const MenuLiquidoPrimaria = await Menu.find({CodigoLiquidoPrimaria:getProductosLiquidoPrimaria.CodigoProducto});
    if (MenuLiquidoPrimaria==0) {
       ...
       montoLiquidoUtilizadoPrimaria; 
        ...
        const newProductoLiquidoPrimaria = {
            ...
            frecuenciaLiquidoPrimariaInicial:frecuenciaLiquidoUtilizadoPrimaria2.toFixed(2),
            montoLiquidoPrimaria:montoLiquidoUtilizadoPrimaria2.toFixed(2)
        }
    ...
    if (MenuSolidoSegundario==0) {
       ...
       montoSolildoUtilizadoSegundario; 
        ...
        const newProductoSolidSegundario = {
            ...
            montoSolildosegundario:montoSolildoUtilizadoSegundario2.toFixed(2)
        }
    ...
    if (MenuLiquidoSegundario==0) {
       ...
       montoLiquidoUtilizadoSegundario; 
        ...
        const newProductoLiquidoSegundario = {
            ...
            frecuenciaLiquidoSegundarioInicial:frecuenciaLiquidoUtilizadoSegundario2.toFixed(2),
            montoLiquidoSegundario:montoLiquidoUtilizadoSegundario2.toFixed(2)
        }
